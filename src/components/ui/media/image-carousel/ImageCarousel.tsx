...
export const meta: ComponentMeta = {
  name: "ImageCarousel",
  description:
    "Animated stacked-card image carousel with auto-rotation and click-to-focus",
};
...
export function ImageCarousel({ images: rawImages }: ImageCarouselProps) {
  ...
  const positions =
    windowWidthRef.current > 1180 ? positionsLarge : positionsSmall;
        ...
        {images.map((image, index) => {
          ...
          return (
            <div
              ...
              className={cn(
                "absolute top-[30%] left-0 overflow-hidden rounded-[20px] border-4 border-[#1b2122] cursor-pointer",
              )}
              style={{
                ...style,
