import{j as e}from"./iframe-CF8stP3p.js";import{A as i,a as g,b}from"./AgentSidebarMessages-BTvNnQTw.js";import"./preload-helper-PPVm8Dsz.js";import"./cn-IyxL_b2c.js";import"./Icon-BZnAYAAq.js";import"./Logo-CrVj4uje.js";import"./IconButton-8LOfoJw8.js";import"./Progress-Bn8RTKha.js";import"./button-styles-CZHSjrxJ.js";import"./AgentSidebarMultiQuestion-DDSW8vFv.js";import"./Button-DRYaUdU_.js";import"./FloatingLabelInput-B3TzEeoP.js";import"./SegmentedButton-DeVHaIEz.js";import"./Switch-DZYO3aQf.js";const F={title:"UI/Agent/Messages",decorators:[f=>e.jsx("div",{className:"h-[420px] w-[420px] rounded-2xl overflow-hidden flex flex-col bg-on-background p-4",children:e.jsx(f,{})})]},d={render:()=>e.jsx(b,{content:"Update my username to alice2 and turn on dark mode."})},c={render:()=>e.jsx(i,{content:"Sure — I'll update your username and your appearance preference. Please confirm the changes below."})},A=`## Account changes
...
}`,...r.parameters?.docs?.source},description:{story:"Agent replies render Markdown: headings, lists, inline + fenced code, links.",...r.parameters?.docs?.description}}};s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:'{\n  render: () => <AgentSidebarAgentMessage content={"Here\'s what I found so far:\\n\\n- Username **alice2** is available\\n- Dark mode is `off`\\n\\n```bash\\nmirrorstack account au"} streaming />\n}',...s.parameters?.docs?.source},description:{story:`Mid-stream markdown — note the unterminated code fence renders calmly
 as a code block until the closing fence arrives.`,...s.parameters?.docs?.description}}};m.parameters={...m.parameters,docs:{...m.parameters?.docs,source:{originalSource:`{
...
}`,...o.parameters?.docs?.source},description:{story:"Brand mark in the sidebar accent below the list when the last message is finished.",...o.parameters?.docs?.description}}};const H=["User","Agent","AgentMarkdown","AgentMarkdownStreaming","AgentStreaming","FinishedWithActions","FeedbackSelected","StreamingHidesActions","WithLogo"];export{c as Agent,r as AgentMarkdown,s as AgentMarkdownStreaming,m as AgentStreaming,n as FeedbackSelected,a as FinishedWithActions,t as StreamingHidesActions,d as User,o as WithLogo,H as __namedExportsOrder,F as default};
