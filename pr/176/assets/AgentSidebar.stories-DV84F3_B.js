import{r as l,j as n}from"./iframe-lCJOq1vo.js";import{A as p,a as b}from"./AgentSidebarInput-7ZugNYL6.js";import{c as v}from"./cn-IyxL_b2c.js";import{a as S,A}from"./AgentSidebarMessage-BdD9MEXg.js";import{A as w}from"./AgentSidebarMultiQuestion-DlKm-Dro.js";import"./preload-helper-PPVm8Dsz.js";import"./IconButton-CX5taMSv.js";import"./Progress-Bbdv1nn8.js";import"./Icon-BjMDZAbI.js";import"./button-styles-DvQkePbc.js";import"./Notch-BXujzoYE.js";import"./Button-Ks3BhErj.js";import"./FloatingLabelInput-BtHV6iB8.js";import"./SegmentedButton-BkcXsF1t.js";import"./Switch-pujlC5Ba.js";const k=80;function x(t){let s=t?.parentElement??null;for(;s;){const r=getComputedStyle(s).overflowY;if(r==="auto"||r==="scroll")return s;s=s.parentElement}return null}function h({messages:t,onSubmitMultiQuestion:s,autoScroll:r=!0,className:m}){const a=l.useRef(null),o=l.useRef(!0),i=l.useRef(!0);return l.useEffect(()=>{const e=x(a.current);if(!e)return;const d=()=>{const y=e.scrollHeight-e.scrollTop-e.clientHeight;i.current=y<=k};return e.addEventListener("scroll",d,{passive:!0}),()=>e.removeEventListener("scroll",d)},[]),l.useEffect(()=>{r&&(!o.current&&!i.current||(a.current?.scrollIntoView({behavior:o.current?"auto":"smooth",block:"end"}),o.current=!1))},[t,r]),n.jsxs("div",{className:v("flex flex-col gap-4",m),children:[t.map(e=>e.role==="user"?n.jsx(S,{content:e.content},e.id):"kind"in e?n.jsx(w,{title:e.title,description:e.description,questions:e.questions,submitLabel:e.submitLabel,status:e.status,layout:e.layout,onSubmit:d=>s?.(e.id,d)},e.id):n.jsx(A,{content:e.content,streaming:e.streaming},e.id)),n.jsx("div",{ref:a})]})}h.__docgenInfo={description:"",methods:[],displayName:"AgentSidebarMessages",props:{messages:{required:!0,tsType:{name:"Array",elements:[{name:"union",raw:`| {
    id: string;
    role: "user";
    content: string;
  }
