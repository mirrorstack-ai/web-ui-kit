import{r as i,j as t}from"./iframe-Bh51IGIh.js";import{A as m,a as p}from"./AgentSidebarInput-B2wOr9_K.js";import{c as y}from"./cn-IyxL_b2c.js";import{a as v,A as x}from"./AgentSidebarMessage-B0gxblOa.js";import"./preload-helper-PPVm8Dsz.js";import"./IconButton-DbCVwoGo.js";import"./Progress-BI_zSzFr.js";import"./Icon-BJzpIAXp.js";import"./button-styles-DvQkePbc.js";import"./Notch-CG8jF9fh.js";const S=80;function A(n){let o=n?.parentElement??null;for(;o;){const r=getComputedStyle(o).overflowY;if(r==="auto"||r==="scroll")return o;o=o.parentElement}return null}function h({messages:n,autoScroll:o=!0,className:r}){const d=i.useRef(null),s=i.useRef(!0),l=i.useRef(!0);return i.useEffect(()=>{const e=A(d.current);if(!e)return;const a=()=>{const b=e.scrollHeight-e.scrollTop-e.clientHeight;l.current=b<=S};return e.addEventListener("scroll",a,{passive:!0}),()=>e.removeEventListener("scroll",a)},[]),i.useEffect(()=>{o&&(!s.current&&!l.current||(d.current?.scrollIntoView({behavior:s.current?"auto":"smooth",block:"end"}),s.current=!1))},[n,o]),t.jsxs("div",{className:y("flex flex-col gap-4",r),children:[n.map(e=>e.role==="user"?t.jsx(v,{content:e.content},e.id):t.jsx(x,{content:e.content,streaming:e.streaming},e.id)),t.jsx("div",{ref:d})]})}h.__docgenInfo={description:"",methods:[],displayName:"AgentSidebarMessages",props:{messages:{required:!0,tsType:{name:"Array",elements:[{name:"union",raw:`| {
    id: string;
    role: "user";
    content: string;
  }
