import{r as i,j as n}from"./iframe-XhBiorVN.js";import{A as h,a as f}from"./AgentSidebarInput-Bye08I5x.js";import{c as w}from"./cn-IyxL_b2c.js";import{I as x}from"./Icon-DBz4HTJf.js";import{a as k,A as M}from"./AgentSidebarMessage-CCORdnrM.js";import{A as q}from"./AgentSidebarMultiQuestion-BMiQCJqQ.js";import"./preload-helper-PPVm8Dsz.js";import"./IconButton-yxKicw9M.js";import"./Progress-BA9SyAHs.js";import"./button-styles-DvQkePbc.js";import"./Notch-BJCjeAQS.js";import"./Button-I1y4RNj0.js";import"./FloatingLabelInput-DhG6LO4S.js";import"./SegmentedButton-CGkXAEQC.js";import"./Switch-BUx0orvM.js";const j=80;function I(t){let s=t?.parentElement??null;for(;s;){const o=getComputedStyle(s).overflowY;if(o==="auto"||o==="scroll")return s;s=s.parentElement}return null}function y({messages:t,onSubmitMultiQuestion:s,autoScroll:o=!0,className:p}){const r=i.useRef(null),l=i.useRef(!0),a=i.useRef(!0),[u,A]=i.useState(!0);i.useEffect(()=>{const e=I(r.current);if(!e)return;const d=()=>{const b=e.scrollHeight-e.scrollTop-e.clientHeight<=j;b!==a.current&&(a.current=b,A(b))};return d(),e.addEventListener("scroll",d,{passive:!0}),()=>e.removeEventListener("scroll",d)},[]),i.useEffect(()=>{o&&(!l.current&&!a.current||(r.current?.scrollIntoView({behavior:l.current?"auto":"smooth",block:"end"}),l.current=!1))},[t,o]);const S=()=>{r.current?.scrollIntoView({behavior:"smooth",block:"end"})};return n.jsxs("div",{className:w("flex flex-col gap-4",p),children:[t.map(e=>e.role==="user"?n.jsx(k,{content:e.content},e.id):"kind"in e?n.jsx(q,{title:e.title,description:e.description,questions:e.questions,submitLabel:e.submitLabel,status:e.status,layout:e.layout,onSubmit:d=>s?.(e.id,d)},e.id):n.jsx(M,{content:e.content,streaming:e.streaming},e.id)),n.jsx("div",{ref:r}),!u&&n.jsx("div",{className:"sticky bottom-2 z-10 flex justify-center pointer-events-none -mt-4",children:n.jsxs("button",{type:"button",onClick:S,className:"pointer-events-auto inline-flex items-center gap-1 rounded-full bg-inverse-on-surface/[0.12] backdrop-blur-sm px-3 py-1.5 text-xs font-medium text-inverse-on-surface hover:bg-inverse-on-surface/[0.20] transition-colors shadow-sm",children:[n.jsx(x,{name:"arrow_downward",size:14}),"Back to bottom"]})})]})}y.__docgenInfo={description:"",methods:[],displayName:"AgentSidebarMessages",props:{messages:{required:!0,tsType:{name:"Array",elements:[{name:"union",raw:`| {
    id: string;
    role: "user";
    content: string;
  }
