import{j as e}from"./iframe-DNBwl0nf.js";import{c as x}from"./cn-IyxL_b2c.js";import{B as l}from"./Button-BfIeY-ag.js";import{I as o}from"./Icon-C_-zc05s.js";import"./preload-helper-PPVm8Dsz.js";import"./Progress-DzZ9VjIz.js";import"./button-styles-BPC6xbbG.js";function d({title:m,description:c,path:p,leading:u,tail:g,className:h}){return e.jsxs("header",{className:x("flex flex-col gap-2",h),children:[p,e.jsxs("div",{className:"flex items-end justify-between gap-4 flex-wrap",children:[e.jsxs("div",{className:"flex items-center gap-3 min-w-0",children:[u,e.jsxs("div",{className:"min-w-0",children:[e.jsx("h1",{className:"text-2xl font-bold text-on-surface",children:m}),c&&e.jsx("p",{className:"mt-1 text-on-surface-variant",children:c})]})]}),g]})]})}d.__docgenInfo={description:"",methods:[],displayName:"PageHeader",props:{title:{required:!0,tsType:{name:"string"},description:"Page title, rendered as an h1."},description:{required:!1,tsType:{name:"string"},description:"Optional supporting copy, rendered below the title."},path:{required:!1,tsType:{name:"ReactNode"},description:`Optional path navigator rendered above the title — back link,
