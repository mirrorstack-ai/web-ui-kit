import{r as i,j as t}from"./iframe-B3h7tW90.js";import{A as h,a as f}from"./AgentSidebarInput-DGQbBfbr.js";import{c as w}from"./cn-IyxL_b2c.js";import{I as x}from"./Icon-CIDYvusA.js";import{a as k,A as M}from"./AgentSidebarMessage-Ckfc-9XV.js";import{A as q}from"./AgentSidebarMultiQuestion-BilFu8CG.js";import"./preload-helper-PPVm8Dsz.js";import"./index-CvWAuDdv.js";import"./index-BwcTCLQ8.js";import"./IconButton-IT1dnrBB.js";import"./Progress-CK2nIvY9.js";import"./button-styles-CZHSjrxJ.js";import"./Notch-CQd26ODM.js";import"./useClickOutside-c5rUn7_z.js";import"./useComposerSubmit-D5UAr5we.js";import"./Button-BYVPmHP8.js";import"./FloatingLabelInput-C818lTsY.js";import"./SegmentedButton-Ke7-WbG5.js";import"./Switch-Dau9Or_U.js";const j=80;function I(n){let s=n?.parentElement??null;for(;s;){const o=getComputedStyle(s).overflowY;if(o==="auto"||o==="scroll")return s;s=s.parentElement}return null}function y({messages:n,onSubmitMultiQuestion:s,autoScroll:o=!0,className:p}){const r=i.useRef(null),l=i.useRef(!0),a=i.useRef(!0),[u,A]=i.useState(!0);i.useEffect(()=>{const e=I(r.current);if(!e)return;const d=()=>{const b=e.scrollHeight-e.scrollTop-e.clientHeight<=j;b!==a.current&&(a.current=b,A(b))};return d(),e.addEventListener("scroll",d,{passive:!0}),()=>e.removeEventListener("scroll",d)},[]),i.useEffect(()=>{o&&(!l.current&&!a.current||(r.current?.scrollIntoView({behavior:l.current?"auto":"smooth",block:"end"}),l.current=!1))},[n,o]);const S=()=>{r.current?.scrollIntoView({behavior:"smooth",block:"end"})};return t.jsxs("div",{className:w("flex flex-col gap-4",p),children:[n.map(e=>e.role==="user"?t.jsx(k,{content:e.content},e.id):"kind"in e?t.jsx(q,{title:e.title,description:e.description,questions:e.questions,submitLabel:e.submitLabel,status:e.status,layout:e.layout,onSubmit:d=>s?.(e.id,d)},e.id):t.jsx(M,{content:e.content,streaming:e.streaming},e.id)),t.jsx("div",{ref:r}),!u&&t.jsx("div",{className:"sticky bottom-2 z-10 flex justify-center pointer-events-none -mt-4",children:t.jsxs("button",{type:"button",onClick:S,className:"pointer-events-auto inline-flex items-center gap-1 rounded-full bg-inverse-on-surface/[0.12] backdrop-blur-sm px-3 py-1.5 text-xs font-medium text-inverse-on-surface hover:bg-inverse-on-surface/[0.20] transition-colors shadow-sm",children:[t.jsx(x,{name:"arrow_downward",size:14}),"Back to bottom"]})})]})}y.__docgenInfo={description:"",methods:[],displayName:"AgentSidebarMessages",props:{messages:{required:!0,tsType:{name:"Array",elements:[{name:"union",raw:`| {
    id: string;
    role: "user";
    content: string;
  }
