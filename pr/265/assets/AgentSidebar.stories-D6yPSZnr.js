import{r as i,j as t}from"./iframe-CCtIIr73.js";import{A as h,a as f}from"./AgentSidebarInput-C3RS3cxg.js";import{c as w}from"./cn-IyxL_b2c.js";import{I as x}from"./Icon-5PsnTv44.js";import{a as k,A as M}from"./AgentSidebarMessage-BH3UyVIO.js";import{A as q}from"./AgentSidebarMultiQuestion-CZJxTfQu.js";import"./preload-helper-PPVm8Dsz.js";import"./index-BZZ5-uGy.js";import"./index-D-1um7j2.js";import"./IconButton-CGt2_lKa.js";import"./Progress-jbkDIFyU.js";import"./button-styles-CZHSjrxJ.js";import"./Notch-CijlT2_W.js";import"./useClickOutside-DCLlMJDI.js";import"./useComposerSubmit-50HDhCfs.js";import"./Button-B9G94EUc.js";import"./FloatingLabelInput-C6iQ0gP6.js";import"./SegmentedButton-BPyrEImq.js";import"./Switch-DkhIY9qT.js";const j=80;function I(n){let s=n?.parentElement??null;for(;s;){const o=getComputedStyle(s).overflowY;if(o==="auto"||o==="scroll")return s;s=s.parentElement}return null}function y({messages:n,onSubmitMultiQuestion:s,autoScroll:o=!0,className:p}){const r=i.useRef(null),l=i.useRef(!0),a=i.useRef(!0),[u,A]=i.useState(!0);i.useEffect(()=>{const e=I(r.current);if(!e)return;const d=()=>{const b=e.scrollHeight-e.scrollTop-e.clientHeight<=j;b!==a.current&&(a.current=b,A(b))};return d(),e.addEventListener("scroll",d,{passive:!0}),()=>e.removeEventListener("scroll",d)},[]),i.useEffect(()=>{o&&(!l.current&&!a.current||(r.current?.scrollIntoView({behavior:l.current?"auto":"smooth",block:"end"}),l.current=!1))},[n,o]);const S=()=>{r.current?.scrollIntoView({behavior:"smooth",block:"end"})};return t.jsxs("div",{className:w("flex flex-col gap-4",p),children:[n.map(e=>e.role==="user"?t.jsx(k,{content:e.content},e.id):"kind"in e?t.jsx(q,{title:e.title,description:e.description,questions:e.questions,submitLabel:e.submitLabel,status:e.status,layout:e.layout,onSubmit:d=>s?.(e.id,d)},e.id):t.jsx(M,{content:e.content,streaming:e.streaming},e.id)),t.jsx("div",{ref:r}),!u&&t.jsx("div",{className:"sticky bottom-2 z-10 flex justify-center pointer-events-none -mt-4",children:t.jsxs("button",{type:"button",onClick:S,className:"pointer-events-auto inline-flex items-center gap-1 rounded-full bg-inverse-on-surface/[0.12] backdrop-blur-sm px-3 py-1.5 text-xs font-medium text-inverse-on-surface hover:bg-inverse-on-surface/[0.20] transition-colors shadow-sm",children:[t.jsx(x,{name:"arrow_downward",size:14}),"Back to bottom"]})})]})}y.__docgenInfo={description:"",methods:[],displayName:"AgentSidebarMessages",props:{messages:{required:!0,tsType:{name:"Array",elements:[{name:"union",raw:`| {
    id: string;
    role: "user";
    content: string;
  }
