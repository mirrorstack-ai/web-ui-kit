...
}`,...n.parameters?.docs?.source},description:{story:"Subdued brand mark below the list when the last message is finished.",...n.parameters?.docs?.description}}};const L=["User","Agent","AgentStreaming","FinishedWithActions","FeedbackSelected","StreamingHidesActions","WithLogo"];export{o as Agent,i as AgentStreaming,s as FeedbackSelected,r as FinishedWithActions,a as StreamingHidesActions,t as User,n as WithLogo,L as __namedExportsOrder,F as default};
