import{r as v,j as e}from"./iframe-BPYAI_Oj.js";import{c as t}from"./cn-IyxL_b2c.js";import{B as k}from"./Button-DmWmLLJq.js";import{I as D}from"./IconButton-FEDDOPIA.js";import"./preload-helper-PPVm8Dsz.js";import"./Progress-8Vl5GWvs.js";import"./button-styles-CKzIKWn5.js";const q={default:null,success:"check_circle",error:"error",warning:"warning",unsave:null},W={default:"border-outline-variant",success:"border-success",error:"border-error",warning:"border-warning",unsave:"border-outline-variant"},y={default:"text-on-surface",success:"text-success",error:"text-error",warning:"text-warning",unsave:"text-on-surface"};function n({message:s,variant:a="default",open:r=!0,onDismiss:i,duration:N,action:g,secondaryAction:f,loading:x=!1,inline:T=!1,className:A}){const[j,w]=v.useState(!1),b=N??(a==="unsave"?0:4e3);if(v.useEffect(()=>{if(r){const h=requestAnimationFrame(()=>w(!0));return()=>cancelAnimationFrame(h)}else w(!1)},[r]),v.useEffect(()=>{if(!r||b===0||!i)return;const h=setTimeout(i,b);return()=>clearTimeout(h)},[r,b,i]),!r&&!j)return null;const S=q[a],C=!!g||!!f;return e.jsx("div",{className:t("z-50 flex justify-center px-4","transition-all duration-300 ease-out",T?"absolute bottom-4 inset-x-0":"fixed bottom-4 inset-x-0",j&&r?"translate-y-0 opacity-100":"translate-y-8 opacity-0 pointer-events-none",A),role:"status","aria-live":"polite","aria-busy":x,children:e.jsx("div",{className:t("w-fit min-w-[280px] max-w-2xl bg-surface-container-high border rounded-2xl shadow-md",W[a]),children:e.jsxs("div",{className:t("px-5 flex items-center justify-between gap-4 min-h-12",C?"py-1.5":"py-2.5"),children:[e.jsxs("div",{className:"flex items-center gap-3",children:[a==="unsave"&&e.jsx("div",{className:"w-2 h-2 rounded-full bg-warning animate-pulse shrink-0"}),S&&e.jsx("span",{className:t("material-symbols-rounded !text-xl shrink-0",y[a]),children:S}),e.jsx("span",{className:t("text-sm whitespace-nowrap",y[a]),children:s})]}),e.jsxs("div",{className:"flex items-center gap-2 shrink-0",children:[f&&e.jsx(k,{variant:"text",size:"sm",onClick:f.onClick,disabled:x,className:"!h-8 !py-1 !text-xs",children:f.label}),g&&e.jsx(k,{size:"sm",onClick:g.onClick,loading:x,className:"!h-8 !py-1 !text-xs",children:g.label}),i&&!C&&e.jsx(D,{icon:"close",variant:"text",size:"sm",className:t("-my-1",y[a]),onClick:i,"aria-label":"Dismiss"})]})]})})})}n.__docgenInfo={description:"",methods:[],displayName:"Snackbar",props:{message:{required:!0,tsType:{name:"string"},description:""},variant:{required:!1,tsType:{name:"union",raw:'"default" | "success" | "error" | "warning" | "unsave"',elements:[{name:"literal",value:'"default"'},{name:"literal",value:'"success"'},{name:"literal",value:'"error"'},{name:"literal",value:'"warning"'},{name:"literal",value:'"unsave"'}]},description:"",defaultValue:{value:'"default"',computed:!1}},open:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"true",computed:!1}},onDismiss:{required:!1,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},duration:{required:!1,tsType:{name:"number"},description:"Auto-dismiss after ms (default: 4000, 0 = no auto-dismiss). Unsave defaults to 0."},action:{required:!1,tsType:{name:"SnackbarAction"},description:""},secondaryAction:{required:!1,tsType:{name:"SnackbarAction"},description:""},loading:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},inline:{required:!1,tsType:{name:"boolean"},description:"Use absolute positioning instead of fixed viewport",defaultValue:{value:"false",computed:!1}},className:{required:!1,tsType:{name:"string"},description:""}}};const _={title:"UI/Feedback/Snackbar",component:n,args:{message:"Changes saved successfully",variant:"default",open:!0,inline:!0},argTypes:{variant:{control:"select",options:["default","success","error","warning","unsave"]},open:{control:"boolean"},loading:{control:"boolean"},inline:{control:"boolean"},duration:{control:"number"},message:{control:"text"}},decorators:[s=>e.jsx("div",{className:"relative min-h-[200px] flex items-end justify-center p-4",children:e.jsx(s,{})})]},o={},c={render:s=>e.jsxs("div",{className:"flex flex-col gap-16",children:[e.jsx(n,{...s,variant:"default",message:"Default notification"}),e.jsx(n,{...s,variant:"success",message:"Changes saved successfully"}),e.jsx(n,{...s,variant:"error",message:"Failed to save changes"}),e.jsx(n,{...s,variant:"warning",message:"Connection unstable"}),e.jsx(n,{...s,variant:"unsave",message:"You have unsaved changes"})]})},l={args:{message:"File uploaded",variant:"success",onDismiss:()=>{}}},d={args:{message:"Item deleted",action:{label:"Undo",onClick:()=>{}}}},u={args:{message:"Discard draft?",action:{label:"Discard",onClick:()=>{}},secondaryAction:{label:"Keep editing",onClick:()=>{}}}},m={args:{message:"Restoring item...",loading:!0,action:{label:"Undo",onClick:()=>{}}}},p={render:s=>{const[a,r]=v.useState(!1);return e.jsxs("div",{className:"relative min-h-[200px]",children:[e.jsx(k,{onClick:()=>r(!0),children:"Show Snackbar"}),e.jsx(n,{...s,message:"Action completed",variant:"success",open:a,onDismiss:()=>r(!1),duration:3e3,inline:!0})]})}};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:"{}",...o.parameters?.docs?.source},description:{story:"Interactive playground — all controls work here",...o.parameters?.docs?.description}}};c.parameters={...c.parameters,docs:{...c.parameters?.docs,source:{originalSource:`{
