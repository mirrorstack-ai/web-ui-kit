import{r as a,j as e}from"./iframe-vRrc7L0F.js";import{A as v,a as f}from"./AgentSidebarInput-CBYbBH38.js";import{c as w}from"./cn-IyxL_b2c.js";import{I as M}from"./Icon-OkqjJjFO.js";import{a as I,A as q}from"./AgentSidebarMessage-CnERe7j2.js";import{A as j}from"./AgentSidebarMultiQuestion-Bbse3AdW.js";import{c as y,m as S,d as N}from"./mock-data-C4gIqsfn.js";import"./preload-helper-PPVm8Dsz.js";import"./index-BuHQBNH9.js";import"./index-CV3Pfa_T.js";import"./IconButton-tsf2saXe.js";import"./Progress-CI7VnNMd.js";import"./button-styles-CZHSjrxJ.js";import"./Notch-CUOwonNJ.js";import"./useClickOutside-C7W2FGhN.js";import"./useMenuKeyNav-kvRR27iN.js";import"./Button-CdNgXUgY.js";import"./FloatingLabelInput-RK5tUVdc.js";import"./SegmentedButton-SQ8Rwnk6.js";import"./Switch-J8Ck-H4Q.js";const H=80;function Q(t){let s=t?.parentElement??null;for(;s;){const r=getComputedStyle(s).overflowY;if(r==="auto"||r==="scroll")return s;s=s.parentElement}return null}function x({messages:t,onSubmitMultiQuestion:s,autoScroll:r=!0,className:b}){const o=a.useRef(null),l=a.useRef(!0),i=a.useRef(!0),[d,A]=a.useState(!0);a.useEffect(()=>{const n=Q(o.current);if(!n)return;const u=()=>{const h=n.scrollHeight-n.scrollTop-n.clientHeight<=H;h!==i.current&&(i.current=h,A(h))};return u(),n.addEventListener("scroll",u,{passive:!0}),()=>n.removeEventListener("scroll",u)},[]),a.useEffect(()=>{r&&(!l.current&&!i.current||(o.current?.scrollIntoView({behavior:l.current?"auto":"smooth",block:"end"}),l.current=!1))},[t,r]);const k=()=>{o.current?.scrollIntoView({behavior:"smooth",block:"end"})};return e.jsxs("div",{className:w("flex flex-col gap-4",b),children:[t.map(n=>n.role==="user"?e.jsx(I,{content:n.content},n.id):"kind"in n?e.jsx(j,{title:n.title,description:n.description,questions:n.questions,submitLabel:n.submitLabel,status:n.status,layout:n.layout,onSubmit:u=>s?.(n.id,u)},n.id):e.jsx(q,{content:n.content,streaming:n.streaming},n.id)),e.jsx("div",{ref:o}),!d&&e.jsx("div",{className:"sticky bottom-2 z-10 flex justify-center pointer-events-none -mt-4",children:e.jsxs("button",{type:"button",onClick:k,className:"pointer-events-auto inline-flex items-center gap-1 rounded-full bg-inverse-on-surface/[0.12] backdrop-blur-sm px-3 py-1.5 text-xs font-medium text-inverse-on-surface hover:bg-inverse-on-surface/[0.20] transition-colors shadow-sm",children:[e.jsx(M,{name:"arrow_downward",size:14}),"Back to bottom"]})})]})}x.__docgenInfo={description:"",methods:[],displayName:"AgentSidebarMessages",props:{messages:{required:!0,tsType:{name:"Array",elements:[{name:"union",raw:`| {
    id: string;
    role: "user";
    content: string;
  }
