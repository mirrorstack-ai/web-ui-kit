import{r as l,j as n}from"./iframe-BgSWei80.js";import{A as p,a as b}from"./AgentSidebarInput-Dlq2HH2o.js";import{c as v}from"./cn-IyxL_b2c.js";import{a as S,A}from"./AgentSidebarMessage-BVN2CL-K.js";import{A as w}from"./AgentSidebarMultiQuestion-C3ZkxbMB.js";import"./preload-helper-PPVm8Dsz.js";import"./IconButton-CQWz2qUR.js";import"./Progress-lW8zcBh0.js";import"./Icon-Dt5BNY_T.js";import"./button-styles-DvQkePbc.js";import"./Notch-B5FSUudr.js";import"./Button-Cb0l05JW.js";import"./FloatingLabelInput-CcZiB1Kt.js";import"./SegmentedButton-UdXNtx9h.js";const k=80;function x(t){let s=t?.parentElement??null;for(;s;){const r=getComputedStyle(s).overflowY;if(r==="auto"||r==="scroll")return s;s=s.parentElement}return null}function h({messages:t,onSubmitMultiQuestion:s,autoScroll:r=!0,className:m}){const a=l.useRef(null),o=l.useRef(!0),i=l.useRef(!0);return l.useEffect(()=>{const e=x(a.current);if(!e)return;const d=()=>{const y=e.scrollHeight-e.scrollTop-e.clientHeight;i.current=y<=k};return e.addEventListener("scroll",d,{passive:!0}),()=>e.removeEventListener("scroll",d)},[]),l.useEffect(()=>{r&&(!o.current&&!i.current||(a.current?.scrollIntoView({behavior:o.current?"auto":"smooth",block:"end"}),o.current=!1))},[t,r]),n.jsxs("div",{className:v("flex flex-col gap-4",m),children:[t.map(e=>e.role==="user"?n.jsx(S,{content:e.content},e.id):"kind"in e?n.jsx(w,{title:e.title,description:e.description,questions:e.questions,submitLabel:e.submitLabel,status:e.status,layout:e.layout,onSubmit:d=>s?.(e.id,d)},e.id):n.jsx(A,{content:e.content,streaming:e.streaming},e.id)),n.jsx("div",{ref:a})]})}h.__docgenInfo={description:"",methods:[],displayName:"AgentSidebarMessages",props:{messages:{required:!0,tsType:{name:"Array",elements:[{name:"union",raw:`| {
    id: string;
    role: "user";
    content: string;
  }
...
}`,...g.parameters?.docs?.source}}};const _=["Header","Input","Playground"];export{u as Header,c as Input,g as Playground,_ as __namedExportsOrder,F as default};
