import{r as l,j as n}from"./iframe-CZB9kqkk.js";import{A as p,a as b}from"./AgentSidebarInput-DS4_23Xn.js";import{c as v}from"./cn-IyxL_b2c.js";import{a as S,A}from"./AgentSidebarMessage-BFEUtBsV.js";import{A as w}from"./AgentSidebarMultiQuestion-D9umcdA1.js";import"./preload-helper-PPVm8Dsz.js";import"./IconButton-gwHALizZ.js";import"./Progress-BYrGqF8I.js";import"./Icon-3ZgFvDk7.js";import"./button-styles-DvQkePbc.js";import"./Notch-DZH10Nec.js";import"./Button-Ui60n5MT.js";import"./Combobox-mbYSg-HS.js";import"./FloatingLabelInput-Dq1o8hbV.js";import"./SegmentedButton-C1Gi1uZ6.js";const k=80;function x(t){let s=t?.parentElement??null;for(;s;){const r=getComputedStyle(s).overflowY;if(r==="auto"||r==="scroll")return s;s=s.parentElement}return null}function f({messages:t,onSubmitMultiQuestion:s,autoScroll:r=!0,className:m}){const a=l.useRef(null),o=l.useRef(!0),i=l.useRef(!0);return l.useEffect(()=>{const e=x(a.current);if(!e)return;const u=()=>{const y=e.scrollHeight-e.scrollTop-e.clientHeight;i.current=y<=k};return e.addEventListener("scroll",u,{passive:!0}),()=>e.removeEventListener("scroll",u)},[]),l.useEffect(()=>{r&&(!o.current&&!i.current||(a.current?.scrollIntoView({behavior:o.current?"auto":"smooth",block:"end"}),o.current=!1))},[t,r]),n.jsxs("div",{className:v("flex flex-col gap-4",m),children:[t.map(e=>e.role==="user"?n.jsx(S,{content:e.content},e.id):"kind"in e?n.jsx(w,{title:e.title,description:e.description,questions:e.questions,submitLabel:e.submitLabel,status:e.status,layout:e.layout,onSubmit:u=>s?.(e.id,u)},e.id):n.jsx(A,{content:e.content,streaming:e.streaming},e.id)),n.jsx("div",{ref:a})]})}f.__docgenInfo={description:"",methods:[],displayName:"AgentSidebarMessages",props:{messages:{required:!0,tsType:{name:"Array",elements:[{name:"union",raw:`| {
    id: string;
    role: "user";
    content: string;
  }
