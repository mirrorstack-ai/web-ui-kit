import{r as l,j as n}from"./iframe-BLRfgVHv.js";import{A as p,a as b}from"./AgentSidebarInput-Ctr-sQ8v.js";import{c as v}from"./cn-IyxL_b2c.js";import{a as S,A}from"./AgentSidebarMessage-Bw4cqCuK.js";import{A as w}from"./AgentSidebarMultiQuestion--aYKJDd3.js";import"./preload-helper-PPVm8Dsz.js";import"./IconButton-Cg7ILYr1.js";import"./Progress-x24eJ29o.js";import"./Icon-xSjVEpeU.js";import"./button-styles-DvQkePbc.js";import"./Notch-vdO2PzQv.js";import"./Button-YQ8NIxpO.js";import"./FloatingLabelInput-aJmo_0yL.js";import"./SegmentedButton-CYW9TMRY.js";const x=80;function k(t){let s=t?.parentElement??null;for(;s;){const r=getComputedStyle(s).overflowY;if(r==="auto"||r==="scroll")return s;s=s.parentElement}return null}function h({messages:t,onSubmitMultiQuestion:s,autoScroll:r=!0,className:m}){const o=l.useRef(null),a=l.useRef(!0),i=l.useRef(!0);return l.useEffect(()=>{const e=k(o.current);if(!e)return;const u=()=>{const y=e.scrollHeight-e.scrollTop-e.clientHeight;i.current=y<=x};return e.addEventListener("scroll",u,{passive:!0}),()=>e.removeEventListener("scroll",u)},[]),l.useEffect(()=>{r&&(!a.current&&!i.current||(o.current?.scrollIntoView({behavior:a.current?"auto":"smooth",block:"end"}),a.current=!1))},[t,r]),n.jsxs("div",{className:v("flex flex-col gap-4",m),children:[t.map(e=>e.role==="user"?n.jsx(S,{content:e.content},e.id):"kind"in e?n.jsx(w,{title:e.title,description:e.description,questions:e.questions,submitLabel:e.submitLabel,status:e.status,layout:e.layout,onSubmit:u=>s?.(e.id,u)},e.id):n.jsx(A,{content:e.content,streaming:e.streaming},e.id)),n.jsx("div",{ref:o})]})}h.__docgenInfo={description:"",methods:[],displayName:"AgentSidebarMessages",props:{messages:{required:!0,tsType:{name:"Array",elements:[{name:"union",raw:`| {
    id: string;
    role: "user";
    content: string;
  }
