import{r as l,j as n}from"./iframe-DjVrgVNu.js";import{A as p,a as b}from"./AgentSidebarInput-BCUAOk5t.js";import{c as v}from"./cn-IyxL_b2c.js";import{a as S,A}from"./AgentSidebarMessage-CyBL6WTR.js";import{A as w}from"./AgentSidebarMultiQuestion-BMvSPvwn.js";import"./preload-helper-PPVm8Dsz.js";import"./IconButton-DjDyqDMf.js";import"./Progress-Dz37890m.js";import"./Icon-DDNVObHv.js";import"./button-styles-DvQkePbc.js";import"./Notch-BGcZEiyb.js";import"./Button-debYfT0q.js";import"./Combobox-GvA5Hmqd.js";import"./SegmentedButton-CIhPYpC3.js";const k=80;function x(t){let s=t?.parentElement??null;for(;s;){const r=getComputedStyle(s).overflowY;if(r==="auto"||r==="scroll")return s;s=s.parentElement}return null}function f({messages:t,onSubmitMultiQuestion:s,autoScroll:r=!0,className:m}){const a=l.useRef(null),o=l.useRef(!0),i=l.useRef(!0);return l.useEffect(()=>{const e=x(a.current);if(!e)return;const u=()=>{const y=e.scrollHeight-e.scrollTop-e.clientHeight;i.current=y<=k};return e.addEventListener("scroll",u,{passive:!0}),()=>e.removeEventListener("scroll",u)},[]),l.useEffect(()=>{r&&(!o.current&&!i.current||(a.current?.scrollIntoView({behavior:o.current?"auto":"smooth",block:"end"}),o.current=!1))},[t,r]),n.jsxs("div",{className:v("flex flex-col gap-4",m),children:[t.map(e=>e.role==="user"?n.jsx(S,{content:e.content},e.id):"kind"in e?n.jsx(w,{title:e.title,description:e.description,questions:e.questions,submitLabel:e.submitLabel,status:e.status,layout:e.layout,onSubmit:u=>s?.(e.id,u)},e.id):n.jsx(A,{content:e.content,streaming:e.streaming},e.id)),n.jsx("div",{ref:a})]})}f.__docgenInfo={description:"",methods:[],displayName:"AgentSidebarMessages",props:{messages:{required:!0,tsType:{name:"Array",elements:[{name:"union",raw:`| {
    id: string;
    role: "user";
    content: string;
  }
