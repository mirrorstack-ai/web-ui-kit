import{r as i,j as t}from"./iframe-B-gvgZHJ.js";import{A as h,a as f}from"./AgentSidebarInput-Dkq23g_a.js";import{c as w}from"./cn-IyxL_b2c.js";import{I as x}from"./Icon-CG6brZKR.js";import{a as k,A as M}from"./AgentSidebarMessage-DP2ip0E5.js";import{A as q}from"./AgentSidebarMultiQuestion-CMI88PjD.js";import"./preload-helper-PPVm8Dsz.js";import"./index-48Bm11tX.js";import"./index-CghTeWZL.js";import"./IconButton-xSLxrOMk.js";import"./Progress-L1_P8j5F.js";import"./button-styles-CZHSjrxJ.js";import"./Notch-B-xY00lt.js";import"./useClickOutside-zeuiwAiw.js";import"./useComposerSubmit-DNDVYRds.js";import"./Button-DqWPrITm.js";import"./FloatingLabelInput-hpeXGIoh.js";import"./SegmentedButton-Cm6D4dFI.js";import"./Switch-Cl6PFel6.js";const j=80;function I(n){let s=n?.parentElement??null;for(;s;){const o=getComputedStyle(s).overflowY;if(o==="auto"||o==="scroll")return s;s=s.parentElement}return null}function y({messages:n,onSubmitMultiQuestion:s,autoScroll:o=!0,className:p}){const r=i.useRef(null),l=i.useRef(!0),a=i.useRef(!0),[u,A]=i.useState(!0);i.useEffect(()=>{const e=I(r.current);if(!e)return;const d=()=>{const b=e.scrollHeight-e.scrollTop-e.clientHeight<=j;b!==a.current&&(a.current=b,A(b))};return d(),e.addEventListener("scroll",d,{passive:!0}),()=>e.removeEventListener("scroll",d)},[]),i.useEffect(()=>{o&&(!l.current&&!a.current||(r.current?.scrollIntoView({behavior:l.current?"auto":"smooth",block:"end"}),l.current=!1))},[n,o]);const S=()=>{r.current?.scrollIntoView({behavior:"smooth",block:"end"})};return t.jsxs("div",{className:w("flex flex-col gap-4",p),children:[n.map(e=>e.role==="user"?t.jsx(k,{content:e.content},e.id):"kind"in e?t.jsx(q,{title:e.title,description:e.description,questions:e.questions,submitLabel:e.submitLabel,status:e.status,layout:e.layout,onSubmit:d=>s?.(e.id,d)},e.id):t.jsx(M,{content:e.content,streaming:e.streaming},e.id)),t.jsx("div",{ref:r}),!u&&t.jsx("div",{className:"sticky bottom-2 z-10 flex justify-center pointer-events-none -mt-4",children:t.jsxs("button",{type:"button",onClick:S,className:"pointer-events-auto inline-flex items-center gap-1 rounded-full bg-inverse-on-surface/[0.12] backdrop-blur-sm px-3 py-1.5 text-xs font-medium text-inverse-on-surface hover:bg-inverse-on-surface/[0.20] transition-colors shadow-sm",children:[t.jsx(x,{name:"arrow_downward",size:14}),"Back to bottom"]})})]})}y.__docgenInfo={description:"",methods:[],displayName:"AgentSidebarMessages",props:{messages:{required:!0,tsType:{name:"Array",elements:[{name:"union",raw:`| {
    id: string;
    role: "user";
    content: string;
  }
...
}`,...m.parameters?.docs?.source}}};const X=["Header","Input","Playground"];export{c as Header,g as Input,m as Playground,X as __namedExportsOrder,Y as default};
