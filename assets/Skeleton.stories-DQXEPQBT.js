import{j as e}from"./iframe-K9yok2IU.js";import{c as d}from"./cn-IyxL_b2c.js";import"./preload-helper-PPVm8Dsz.js";function s({width:r="w-full",height:t="h-4",className:c="",lines:p=1}){const h=Math.max(1,Math.round(p));return h>1?e.jsx("div",{className:d("space-y-2",c),children:Array.from({length:h},(g,m)=>e.jsx("div",{className:d(r,t,"bg-surface-container-highest rounded animate-pulse")},m))}):e.jsx("div",{className:d(r,t,"bg-surface-container-highest rounded animate-pulse",c)})}s.__docgenInfo={description:"",methods:[],displayName:"Skeleton",props:{width:{required:!1,tsType:{name:"string"},description:'Tailwind width class (e.g. "w-full", "w-48")',defaultValue:{value:'"w-full"',computed:!1}},height:{required:!1,tsType:{name:"string"},description:'Tailwind height class (e.g. "h-4", "h-8")',defaultValue:{value:'"h-4"',computed:!1}},className:{required:!1,tsType:{name:"string"},description:"Additional classes",defaultValue:{value:'""',computed:!1}},lines:{required:!1,tsType:{name:"number"},description:"Renders multiple skeleton bars with vertical spacing",defaultValue:{value:"1",computed:!1}}}};function u({children:r,label:t}){return e.jsx("div",{role:"status","aria-busy":"true","aria-label":t,children:e.jsx("div",{"aria-hidden":"true",children:r})})}u.__docgenInfo={description:`Announces a loading region once while hiding its decorative placeholders
