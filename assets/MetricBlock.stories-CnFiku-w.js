...
}`,...f.parameters?.docs?.source},description:{story:'`layout="chart"` for 3×3 and larger — chart-led: header (label · trend), a\n full-width sparkline filling the middle, and a stats row underneath. No big\n value — the chart and stats carry it. Hover a bar for its labelled value.',...f.parameters?.docs?.description}}};const F=["Playground","Sizes","BigCard"];export{f as BigCard,b as Playground,g as Sizes,F as __namedExportsOrder,X as default};
