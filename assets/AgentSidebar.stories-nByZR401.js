import{r as i,j as t}from"./iframe-CaQP8Vxo.js";import{A as h,a as f}from"./AgentSidebarInput-DYFKN91V.js";import{c as w}from"./cn-IyxL_b2c.js";import{I as x}from"./Icon-C8KZm0Wn.js";import{a as k,A as M}from"./AgentSidebarMessage-b5kgxtH4.js";import{A as q}from"./AgentSidebarMultiQuestion-Bo7RzJh2.js";import"./preload-helper-PPVm8Dsz.js";import"./index-teixukzN.js";import"./index-D9qRpt3W.js";import"./IconButton-C64WHNMQ.js";import"./Progress-C-atwjov.js";import"./button-styles-CZHSjrxJ.js";import"./Notch-RMUcPg7c.js";import"./useClickOutside-9JxNPxuZ.js";import"./useComposerSubmit-Dj7O-a6f.js";import"./Button-Cxw_Htzh.js";import"./FloatingLabelInput-CnGxklcg.js";import"./SegmentedButton-B2PnuyfF.js";import"./Switch-BPFMYj7U.js";const j=80;function I(n){let s=n?.parentElement??null;for(;s;){const o=getComputedStyle(s).overflowY;if(o==="auto"||o==="scroll")return s;s=s.parentElement}return null}function y({messages:n,onSubmitMultiQuestion:s,autoScroll:o=!0,className:p}){const r=i.useRef(null),l=i.useRef(!0),a=i.useRef(!0),[u,A]=i.useState(!0);i.useEffect(()=>{const e=I(r.current);if(!e)return;const d=()=>{const b=e.scrollHeight-e.scrollTop-e.clientHeight<=j;b!==a.current&&(a.current=b,A(b))};return d(),e.addEventListener("scroll",d,{passive:!0}),()=>e.removeEventListener("scroll",d)},[]),i.useEffect(()=>{o&&(!l.current&&!a.current||(r.current?.scrollIntoView({behavior:l.current?"auto":"smooth",block:"end"}),l.current=!1))},[n,o]);const S=()=>{r.current?.scrollIntoView({behavior:"smooth",block:"end"})};return t.jsxs("div",{className:w("flex flex-col gap-4",p),children:[n.map(e=>e.role==="user"?t.jsx(k,{content:e.content},e.id):"kind"in e?t.jsx(q,{title:e.title,description:e.description,questions:e.questions,submitLabel:e.submitLabel,status:e.status,layout:e.layout,onSubmit:d=>s?.(e.id,d)},e.id):t.jsx(M,{content:e.content,streaming:e.streaming},e.id)),t.jsx("div",{ref:r}),!u&&t.jsx("div",{className:"sticky bottom-2 z-10 flex justify-center pointer-events-none -mt-4",children:t.jsxs("button",{type:"button",onClick:S,className:"pointer-events-auto inline-flex items-center gap-1 rounded-full bg-inverse-on-surface/[0.12] backdrop-blur-sm px-3 py-1.5 text-xs font-medium text-inverse-on-surface hover:bg-inverse-on-surface/[0.20] transition-colors shadow-sm",children:[t.jsx(x,{name:"arrow_downward",size:14}),"Back to bottom"]})})]})}y.__docgenInfo={description:"",methods:[],displayName:"AgentSidebarMessages",props:{messages:{required:!0,tsType:{name:"Array",elements:[{name:"union",raw:`| {
    id: string;
    role: "user";
    content: string;
  }
