import{j as e}from"./iframe-B1L9UjRD.js";import{c as d}from"./cn-IyxL_b2c.js";import{t as l}from"./tone-B_C-zL0B.js";function c({title:i,description:t,leading:r,control:s,tone:n,className:a}){const o=n?l[n]:"border-outline-variant";return e.jsxs("div",{className:d("flex flex-wrap items-center gap-4 px-4 py-3 rounded-xl border bg-surface-container",o,a),children:[r?e.jsx("div",{className:"shrink-0 flex items-center",children:r}):null,e.jsxs("div",{className:"min-w-0 grow basis-48 space-y-1.5",children:[e.jsx("p",{className:"text-sm font-medium text-on-surface",children:i}),t&&e.jsx("p",{className:"text-xs text-on-surface-variant",children:t})]}),e.jsx("div",{className:"shrink-0 flex items-center",children:s})]})}c.__docgenInfo={description:"",methods:[],displayName:"SettingRow",props:{title:{required:!0,tsType:{name:"string"},description:"Primary heading for the row."},description:{required:!1,tsType:{name:"string"},description:"Optional supporting copy, rendered below the title."},leading:{required:!1,tsType:{name:"ReactNode"},description:`Optional mark, icon or badge rendered IN FRONT of the text.
...
(omitted) renders with the neutral outline-variant border.`},className:{required:!1,tsType:{name:"string"},description:""}}};export{c as S};
