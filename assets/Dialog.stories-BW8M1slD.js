...
}`,...o.parameters?.docs?.source},description:{story:"Pass `hideCloseButton` to suppress the built-in X — useful for hard-confirm\nflows where Escape / backdrop dismissal is also disabled and the only valid\nexit is one of the action buttons.",...o.parameters?.docs?.description}}};const D=["Playground","WithActions","LoadingAction","NoTitle","WithCloseButton","HideCloseButton"];export{o as HideCloseButton,l as LoadingAction,r as NoTitle,a as Playground,s as WithActions,n as WithCloseButton,D as __namedExportsOrder,y as default};
