import{j as e}from"./iframe-BOlRW1mm.js";import{a as t,b as g,c as k}from"./AgentSidebarMessages-C12U3LZx.js";import"./preload-helper-PPVm8Dsz.js";import"./cn-IyxL_b2c.js";import"./Icon-_EeMZLlo.js";import"./Logo-BhpTBLHp.js";import"./IconButton-DF0s7CS-.js";import"./Progress-io9PjziW.js";import"./button-styles-CZHSjrxJ.js";import"./AgentSidebarMultiQuestion-CkycXZ7p.js";import"./Button-BGP0m-0d.js";import"./FloatingLabelInput-j0HRKYbh.js";import"./SegmentedButton-CJ6vvt4R.js";import"./Switch-D1Uz28bL.js";const H={title:"UI/Agent/Messages",decorators:[b=>e.jsx("div",{className:"h-[420px] w-[420px] rounded-2xl overflow-hidden flex flex-col bg-on-background p-4",children:e.jsx(b,{})})]},l={render:()=>e.jsx(k,{content:"Update my username to alice2 and turn on dark mode."})},m={render:()=>e.jsx(t,{content:"Sure — I'll update your username and your appearance preference. Please confirm the changes below."})},A=`## Account changes
...
\`\`\`bash
mirrorstack account au`,streaming:!0})},p={render:()=>e.jsxs("div",{className:"flex flex-col gap-4",children:[e.jsx(t,{content:"",streaming:!0}),e.jsx(t,{content:"Updating your profile now",streaming:!0})]})},n={render:()=>e.jsx(t,{content:`Let me check your recent posts and tidy up the drafts.

Done — published the latest draft and archived the two stale ones.`,segments:[{type:"text",text:"Let me check your recent posts and tidy up the drafts."},{type:"tool",id:"t-1",tool:{moduleSlug:"cms",tool:"list_posts",status:"done",durationMs:214,args:{limit:5},result:[{id:"p1",title:"Hello world"}]}},{type:"tool",id:"t-2",tool:{moduleSlug:"cms",tool:"publish_post",status:"done",durationMs:96}},{type:"text",text:"Done — published the latest draft and archived the two stale ones."}]})},a={render:()=>e.jsx(t,{streaming:!0,content:"Checking your account settings.",segments:[{type:"text",text:"Checking your account settings."},{type:"tool",id:"t-1",tool:{moduleSlug:"account",tool:"get_preferences",status:"started"}}]})},y=()=>{},u={onCopyMessage:y,onRateMessage:y,onRerunMessage:y},f={id:"m-2",role:"agent",content:"You changed your username to alice2, enabled dark mode, and added a passkey from your MacBook."},h=[{id:"m-1",role:"user",content:"Summarize my account changes this week."},f],o={render:()=>e.jsx(g,{messages:h,...u})},i={render:()=>e.jsx(g,{messages:[h[0],{...f,feedback:"up"}],...u})},d={render:()=>e.jsx(g,{messages:[h[0],{id:"m-2",role:"agent",content:"Pulling your audit log",streaming:!0}],...u})},c={render:()=>e.jsx(g,{messages:h,...u,showLogo:!0})};l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:`{
 ...
 renders calmly as a code block until the closing fence arrives.`,...r.parameters?.docs?.description}}};p.parameters={...p.parameters,docs:{...p.parameters?.docs,source:{originalSource:`{
...
}`,...c.parameters?.docs?.source},description:{story:"Brand mark in the sidebar accent below the list when the last message is finished.",...c.parameters?.docs?.description}}};const F=["User","Agent","AgentMarkdown","AgentMarkdownStreaming","AgentStreaming","AgentInterleavedToolCalls","AgentInterleavedStreaming","FinishedWithActions","FeedbackSelected","StreamingHidesActions","WithLogo"];export{m as Agent,a as AgentInterleavedStreaming,n as AgentInterleavedToolCalls,s as AgentMarkdown,r as AgentMarkdownStreaming,p as AgentStreaming,i as FeedbackSelected,o as FinishedWithActions,d as StreamingHidesActions,l as User,c as WithLogo,F as __namedExportsOrder,H as default};
